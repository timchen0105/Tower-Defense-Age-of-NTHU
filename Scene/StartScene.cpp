...
void StartScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Age of NTHU", "pirulen.ttf", 90, halfW, halfH / 3 + 180, 10, 255, 255, 255, 0.5, 0.5));
...
void StartScene::PlayOnClick(int stage) {
    Engine::GameEngine::GetInstance().ChangeScene("gamemode-select");
}
